...
{
    public class ASManualParaVM : DlyNotifyPropertyChanged
    {
        #region 属性
        private ASManualPara m_item = null;
        public ASManualPara MItem
        {
            get
            {
                return m_item;
        ...
        public EnumMonitorActionManual MAction
        {
            get
            {
        ...
        public ASManualParaVM(ASManualPara item)
        {
            MItem = item;
        }
    }
