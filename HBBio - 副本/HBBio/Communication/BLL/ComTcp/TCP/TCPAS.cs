...
namespace HBBio.Communication
{
    class TCPAS : BaseTCP
    {
        ...
        /// 构造函数
        /// </summary>
        public TCPAS(ComConf info) : base(info)
        {
        ...
        public override List<object> GetRunDataValueList()
        {
            ...
            if (m_item.MVisible)
            {
                ...
                if (m_item.m_sizeGet > StaticSystemConfig.SSystemConfig.MListConfAS[(int)m_item.m_name].MSize)
                {
                    MForeground = Brushes.Red;
                }
                else
                {
                    MForeground = Brushes.Gray;
                }
            }
